            ...
            ytdl.getInfo(client_url, function(err, info) {
                ...
                if (file_type === "mp3") {
                    ytdl(client_url, {
                        ...
                        .pipe(fs.createWriteStream(path.join(__dirname, '/../archive/mp3/' + video_id + '.mp3')));
                } else {
                    ytdl(client_url, {
                            filter: (format) => format.container === 'mp4'
                        })
                        .pipe(fs.createWriteStream(path.join(__dirname, '/../archive/mp4/' + video_id + '.mp4'))); //Changed from Clean Title!!!
                }
